...
// Aggiungi la dicitura nelle note (corretta sintassi)
...
console.log('✅ test-invoice.js corretto con dicitura imposta di bollo!');
console.log('   - Aggiunta riga separata per imposta di bollo');
console.log('   - Aggiunta dicitura completa nelle note');
console.log('   - Corretta sintassi JavaScript');
